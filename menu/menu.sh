...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/huutvpn/ipsaya/main/izin > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/huutvpn/ipsaya/main/izin | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/huutvpn/ipsaya/main/izin | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/huutvpn/ipsaya/main/izin | grep $MYIP | awk '{print $3}')
fi
...
clear               
		    ...
		    echo -e "${Kcyan} ${NC}${greenC}              Authorz : 🇮🇩huut🇮🇩 "
                    echo -e "${Kcyan}└───────────────────────────────────────────┘${NC}"
                    echo -e "${Kcyan}┌───────────────────────────────────────────┐"
