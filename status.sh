...
# Author  : HUUTVPN GROUP
# (C) Copyright 2021-2022 By huutvpn Tunnel
# =========================================
...
echo -e "                  CREATOR : ${GREEN} HUUTVPN ${NC}${YELLOW}${NC} ${GREEN}TUNNEL ${NC}${YELLOW}${NC}"
echo -e "       © Copyright By HuutVpn-tunnel ${YELLOW}(${NC} 2014-2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
